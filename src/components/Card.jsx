export default function Card({ data }) {
	...
	return (
		<div className="">
			{data.map((d, i) => (
				<div className="w-full h-[300px] mx-auto max-w-md rounded-xl shadow-md overflow-hidden md:max-w-2xl mb-5 bg-blue-500 rounded-lg" key={d.url}
				>
					...
					<div className="md:flex">
						<div className="md:flex-shrink-0">
						{
							...
							/>
							: 
							<p className="text-center text-2xl text-gray-200">Failed to fetch articles image</p>
						}
						...
						<div className="p-6 md:p-8">
							...
							<div className="flex justify-between flex-end">
								<div className="flex justify-between">
									...
									<span className="mt-2 text-gray-200">{d.source.id}</span>
								</div>
